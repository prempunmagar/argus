...
| `key_prefix`     | VARCHAR(20)  | NOT NULL                          | First 12 chars for display: `argus_ck_7f3b`          |
...
**Error handling:** Retry once. If still fails, fallback to description-based categorization with `category_confidence=0.5`.

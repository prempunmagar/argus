...
- **`argus-kes-guide.md`** — What my teammate (Kes) is building (backend, plugin, A2A, deploy). Useful for understanding what APIs I'll consume.
...
├── argus-kes-guide.md          # Kes's guide — backend/plugin/A2A (for reference)
└── CLAUDE.md                   # This file
```

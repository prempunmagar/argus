...
export const mockTransactions: Transaction[] = [
  ...
  },
  {
    ...
    request_data: {
      ...
      merchant_url: "https://bestbuy.com/checkout",
    },
    evaluation: {
      decision: "DENY",
  ...
  },
  {
    ...
    request_data: {
      ...
      merchant_url: "https://marriott.com/checkout",
    },
    evaluation: {
  ...
  },
  {
    ...
    evaluation: {
      ...
      intent_match: 0.95,
      decision_reasoning: "Under $100 auto-approve threshold. Trusted merchant.",
    },
  ...
  },
  {
    ...
    evaluation: {
      ...
      intent_match: 0.88,
      decision_reasoning: "Approved by user after manual review.",
    },
...
export const mockConnectionKeys: ConnectionKey[] = [
  {
    id: "ck_demo_001",
...
export const mockTransactionDetail: TransactionDetail = {
  ...
  evaluation: {
    ...
    category_confidence: 0.94,
    intent_match: 0.92,
    decision_reasoning: "Within Footwear budget and trusted merchant. Auto-approved.",
    risk_flags: [],
    rules_checked: [
      {
        rule_id: "r1",
